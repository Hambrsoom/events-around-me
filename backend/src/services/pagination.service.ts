...
export class PaginationService {
    public static getElements(after: string, first: number, elementsFromDatabase: any[]): any {
    ...
    public static getStartingPoint(after: string, elementsFromDatabase: any[]): number {
        if (after !== undefined) {
    ...
    public static SliceListOfElements(start: number, first: number, elements: any[]) {
        return first === undefined ?
            elements :
            elements.slice(start, start + first);
    }

    public static definePageInfo(start: number, first: number, totalCount: number, endCursor: string): PageInfo {
    ...
    public static defineEdges(elements: any[]): { edges: any[], endCursor:string} {
